...
This project uses Terraform to provision and manage a web server infrastructure on AWS. It demonstrates how Infrastructure as Code (IaC) can be used to automate the creation of cloud resources in a consistent and repeatable way.
